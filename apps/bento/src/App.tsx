...
import { TraitsProvider } from "@/lib/appearance/style-context"
import { ThemeProvider, type Theme } from "@/lib/appearance/theme-context"
import { initProfileDefault } from "@/lib/settings/profile-store"
import { syncSkillsPreferences } from "@/lib/settings/skills-preferences"
...
import { liveMeta, useLive } from "@/lib/sessions/live-store"
import { useLayout } from "@/lib/workspace/layout-store"
import { initCollaborationUi } from "@/lib/workspace/collaboration-ui"
import { requestNewSession } from "@/lib/sessions/new-session-store"
import { useSettingsPage } from "@/lib/settings/settings-store"
import {
  setWorkspaceToolsOpen,
  toggleWorkspaceTools,
  useWorkspaceToolsOpen,
  useWorkspaceToolsStarted,
} from "@/lib/workspace/workspace-tools-store"
import { useWorkspaceBrowserReveal } from "@/lib/workspace/workspace-browser-reveal"
import { consumeWorkspaceFileReveal, useWorkspaceFileReveal } from "@/lib/workspace/workspace-file-reveal"
