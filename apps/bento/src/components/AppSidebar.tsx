...
import { closeSession, openAppsView, openSession, useLayout } from "@/lib/workspace/layout-store"
import { closeNewSession, requestNewSession, useNewSession } from "@/lib/sessions/new-session-store"
import { useTheme } from "@/lib/appearance/theme-context"
import { profileInitial, useProfile } from "@/lib/settings/profile-store"
...
} from "@/lib/workspace/folder-preferences"
import { hasUnreadSessionMessage, isRunning, liveMeta, removeLive, renameLive, useLive, hasPendingApproval } from "@/lib/sessions/live-store"
