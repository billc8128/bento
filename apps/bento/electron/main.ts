...
import { AppUpdateController } from "./platform/app-update"
...
import { SkillsService } from "./skills/skills"
import { listPermissionRulesByProject, removePermissionRule } from "./permissions/permission-rules"
...
import { ProviderDiscoveryService } from "./providers/provider-discovery"
import { ProviderRoutingService } from "./providers/provider-routing"
import { builtinProvidersForHarness } from "./providers/builtin-providers"
import { runOAuthLogin } from "./providers/oauth-runner"
import { LocalProviderScanner } from "./providers/provider-import"
import type { LocalProviderCandidate } from "../src/core/provider-preset"
import { listHarnessRuntimeStatuses, warmHarnessRuntimeVersions } from "./runtime/harness-runtime"
import { ModelVisibilityStore } from "./providers/model-visibility"
import { ProviderModelCache } from "./providers/provider-model-cache"
...
import { AgentSelectionCatalog } from "./collaboration/collaboration-catalog"
...
app.whenReady().then(async () => {
  ...
  appRuntime = new AppRuntimeHost(
    ...
    path.join(app.getAppPath(), "electron/apps/mcp-http-relay.mjs"),
    path.join(app.getAppPath(), "electron/apps/pi-mcp-extension.mjs"),
    (id) => {
