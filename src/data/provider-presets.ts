...
export const PROVIDER_PRESETS: ProviderPreset[] = [
  ...
  dual({ id: "zai-api", name: "Z.ai GLM Global", docsUrl: "https://docs.z.ai/devpack/tool/claude", claudeBaseUrl: "https://api.z.ai/api/anthropic", codexBaseUrl: "https://api.z.ai/api/paas/v4", modelsUrl: false }),
  dual({ id: "zhipu-glm-cn", name: "智谱 GLM 中国大陆", docsUrl: "https://docs.bigmodel.cn/cn/guide/develop/claude", claudeBaseUrl: "https://open.bigmodel.cn/api/anthropic", codexBaseUrl: "https://open.bigmodel.cn/api/paas/v4", modelsUrl: false, region: "cn" }),
  dual({
