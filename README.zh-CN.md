...
<p align="center">
  ...
  <a href="https://github.com/billc8128/bento/releases/download/v0.4.6/Bento-0.4.6-arm64.dmg">下载</a> ·
...
> [!NOTE]
> Bento 仍在快速迭代。当前版本为 **v0.4.6**，仅提供 **Apple 芯片 Mac**
> 版本；产品形态与扩展契约仍可能调整。
...
[下载 Bento v0.4.6 macOS 版（Apple 芯片）](https://github.com/billc8128/bento/releases/download/v0.4.6/Bento-0.4.6-arm64.dmg)，打开 DMG，然后把 Bento 移入“应用程序”。
